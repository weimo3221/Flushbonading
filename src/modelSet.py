...
class Module2(nn.Module):
    ...
    def forward(self, src, tgt):
        ...
        src_key_padding_mask = Module2.get_key_padding_mask(src).type(torch.bool).to(src.device)  # [B, T1]
        tgt_key_padding_mask = Module2.get_key_padding_mask(tgt).type(torch.bool).to(src.device)  # [B, T2]
