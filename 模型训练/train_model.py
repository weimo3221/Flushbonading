...
from modelSet import Module2, LstmEncoder, LstmDecoder
...
def parse_args():
    ...
    parser.add_argument("--encoder", "-encoder", type=str, default="Transformer", help="Transformer or LSTM")
...
if __name__ == "__main__":
    ...
    # 选择所想要进行训练的模型种类
    print("一共有如下几种模式选择：\n"
          "1.双向LSTM+单向LSTM；2.Transformer+Transformer")
    ...
    if args.encoder == "LSTM" and args.decoder == "LSTM":
        ...
        layer_dim = 2
        n_head = 8
        module = Module2(d_model=embedding_dim, vocab_size=vocab_size, num_layers=layer_dim, n_head=n_head).to(device)
